    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-6 space-y-4">
          ...
          <ProposalContentEditor value={customContent} onChange={(value) => setCustomContent(value as ProposalCustomContent)} onReset={() => setCustomContent(getDefaultProposalContent())} mode="backup" />
        </CardContent>
      </Card>
      ...
      <div className="flex flex-wrap gap-2 justify-end sticky bottom-0 bg-white py-3 border-t">
        ...
        <Button variant="outline" onClick={() => handlePreview('modelo03')} disabled={!!previewLoading || saveMutation.isPending}>
