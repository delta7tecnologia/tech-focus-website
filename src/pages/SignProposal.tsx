...
const SignProposal = () => {
  useSEO({ title: 'Assinar proposta comercial | Delta7 Tecnologia', description: 'Página segura para revisar e assinar digitalmente a proposta comercial da Delta7 Tecnologia.', noindex: true });
          ...
          <CardContent className="p-6 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h1 className="text-xl font-bold text-blue-900">Proposta Comercial {proposal.proposal_number}</h1>
                <p className="text-sm text-gray-600">{proposal.client_name}</p>
                <p className="text-xs text-gray-500 mt-1">Mensal: <strong>{formatBRL(Number(proposal.monthly_total) || 0)}</strong> · Ativação: {formatBRL(Number(proposal.activation_fee) || 0)} · Validade {proposal.validity_days} dias</p>
              </div>
            </div>
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-xs text-gray-500">
                Ao assinar, você confirma o aceite dos termos, valores e condições desta proposta. Sua assinatura, nome, data e horário ficarão registrados.
              </p>
              <Button
                type="button"
